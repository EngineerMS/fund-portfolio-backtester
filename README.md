...
This project is developed for educational and personal financial analysis purposes only. 
* **Not Financial Advice:** The historical data, simulations, and charts generated by this engine do not constitute financial, investment, or legal advice. 
* **Data Accuracy:** Price data is fetched from public sources via open-source APIs. The author cannot guarantee the absolute accuracy, completeness, or timeliness of the data provided by external systems.
* **Risk Warning:** Past performance is not indicative of future results. All financial investments carry risks, and users are solely responsible for their own investment decisions.
